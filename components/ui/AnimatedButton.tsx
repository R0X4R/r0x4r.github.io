    ...
    return (
        <AnimatePresence mode="wait">
            {isClicked ? (
                ...
                <motion.button
                    className={`relative flex items-center justify-center overflow-hidden p-0 ${className}`} // Apply custom styling
                ...
                >
                    ...
                    <motion.span
                        key="clicked"
                        className={`relative flex items-center justify-center w-full ${changeTextClassName}`} // Apply changeText className
                ...
                <motion.button
                    className={`relative flex cursor-pointer items-center justify-center ${className}`} // Apply custom styling
                ...
                >
                    ...
                    <motion.span
                        key="not-clicked"
                        className="relative flex items-center justify-center" // Flexbox for centering text
                        {...animation} // Apply selected animation
                    >
